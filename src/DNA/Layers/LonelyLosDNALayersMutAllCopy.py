...
# Number of layers changed by mutations, newly added layers are mutated copies of the last layer in the list.
# Upon mutating the number of neurons in the layers all layers are mutated.
