...
from src.SOTA.CapsNet_Tensorflow_master.utils import get_shape
    ...
    def __call__(self, input, kernel_size=None, stride=None):
        ...
        if self.layer_type == 'CONV':
            ...
            if not self.with_routing:
                ...
                capsules = tf.compat.v1.layers.conv2d(input, self.num_outputs * self.vec_len,
        ...
        if self.layer_type == 'FC':
            if self.with_routing:
                ...
                with tf.compat.v1.variable_scope('routing'):
                    ...
                    b_IJ = tf.constant(np.zeros([cfg.batch_size, input.shape[1], self.num_outputs, 1, 1], dtype=np.float32))
